...
export default function SignupComponent() {
    ...
    return (
        <div className="relative mt-20 mx-auto w-full max-w-md bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10">
            <div className="w-full">
                ...
                <div className="mt-5">
                    ...
                    <div className="my-6">
                        <button onClick={signupfn} className="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Sign Up</button>
                    </div>
